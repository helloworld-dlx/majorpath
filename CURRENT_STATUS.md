...
- **当前版本**：v0.16.1（推荐修复 — STEM 数学保护 + 权重调优 + 模拟器/调参工具 + 专业画像 61 + oneLiner 修复）
- **更新日期**：2026-06-06 14:00
...
| 日期 | 更新内容 |
|------|----------|
| 2026-06-06 14:00 | **v0.16.1** 推荐引擎修复：scoring.ts 低数学 STEM 保护（矛盾率 24%→11%）；权重调优 6 处（数学 25→6、电气 6→10、航空 4→14、土木 5→2、新增仪器 6、能源动力 7）；专业画像 39→61；模拟器/调参工具全套上线；oneLiner 风格修复 |
