...
import type { CategoryWeightEntry } from '../types/categoryFields';
...
> = {
  '01': [ // 哲学
    { categorySlug: 'philosophy-class', buckets: ['humanities'], weight: 11 },
  ],
  '02': [ // 经济学
    { categorySlug: 'economics-class', buckets: ['business'], weight: 20 },
    { categorySlug: 'finance', buckets: ['business'], weight: 17 },
    { categorySlug: 'international-trade', buckets: ['business'], weight: 8 },
    { categorySlug: 'public-finance', buckets: ['business'], weight: 8 },
  ],
  '03': [ // 法学
    { categorySlug: 'law-class', buckets: ['social_science'], weight: 20 },
    { categorySlug: 'political-science', buckets: ['social_science'], weight: 8 },
    { categorySlug: 'sociology', buckets: ['social_science'], weight: 8 },
    { categorySlug: 'ethnology', buckets: ['social_science'], weight: 3 },
    { categorySlug: 'marxism', buckets: ['social_science'], weight: 7 },
    { categorySlug: 'public-security', buckets: ['social_science'], weight: 4 },
  ],
  '04': [ // 教育学
    { categorySlug: 'education', buckets: ['social_science'], weight: 20 },
    { categorySlug: 'physical-education', buckets: ['social_science'], weight: 7 },
  ],
  '05': [ // 文学
    { categorySlug: 'chinese-literature', buckets: ['humanities'], weight: 19 },
    { categorySlug: 'foreign-languages', buckets: ['humanities'], weight: 15 },
    { categorySlug: 'journalism', buckets: ['humanities', 'social_science'], weight: 13 },
  ],
  '06': [ // 历史学
    { categorySlug: 'history-class', buckets: ['humanities'], weight: 11 },
  ],
  '07': [ // 理学
    { categorySlug: 'mathematics', buckets: ['stem'], weight: 9 },
    { categorySlug: 'physics', buckets: ['stem'], weight: 7 },
    { categorySlug: 'chemistry', buckets: ['stem'], weight: 6 },
    { categorySlug: 'biology', buckets: ['stem', 'life_health'], weight: 12 },
    { categorySlug: 'statistics', buckets: ['stem', 'business'], weight: 16 },
    { categorySlug: 'astronomy', buckets: ['stem'], weight: 3 },
    { categorySlug: 'geography', buckets: ['stem'], weight: 7 },
    ...
    { categorySlug: 'geology', buckets: ['stem'], weight: 3 },
    { categorySlug: 'psychology', buckets: ['social_science', 'life_health'], weight: 11 },
  ],
  '08': [ // 工学 — 全部 32 个专业类
    { categorySlug: 'computer-science', buckets: ['stem'], weight: 16 },
    { categorySlug: 'electronic-information', buckets: ['stem'], weight: 14 },
    { categorySlug: 'electrical', buckets: ['stem'], weight: 11 },
    { categorySlug: 'automation', buckets: ['stem'], weight: 11 },
    { categorySlug: 'mechanical', buckets: ['stem'], weight: 10 },
    { categorySlug: 'aerospace', buckets: ['stem'], weight: 5 },
    { categorySlug: 'energy-power', buckets: ['stem'], weight: 11 },
    { categorySlug: 'instrumentation', buckets: ['stem'], weight: 8 },
    { categorySlug: 'civil-engineering', buckets: ['stem'], weight: 7 },
    { categorySlug: 'materials', buckets: ['stem'], weight: 7 },
    { categorySlug: 'architecture', buckets: ['stem', 'art_creative'], weight: 6 },
    { categorySlug: 'biomedical-eng', buckets: ['stem', 'life_health'], weight: 6 },
    { categorySlug: 'mechanics', buckets: ['stem'], weight: 4 },
    { categorySlug: 'water-resources', buckets: ['stem'], weight: 5 },
    { categorySlug: 'surveying', buckets: ['stem'], weight: 4 },
    { categorySlug: 'chemical-pharma', buckets: ['stem'], weight: 7 },
    { categorySlug: 'geological-eng', buckets: ['stem'], weight: 3 },
  ...
  '09': [ // 农学
    { categorySlug: 'plant-production', buckets: ['life_health'], weight: 10 },
    { categorySlug: 'environmental-ecology', buckets: ['life_health', 'stem'], weight: 9 },
    { categorySlug: 'veterinary', buckets: ['life_health'], weight: 14 },
    { categorySlug: 'animal-production', buckets: ['life_health'], weight: 9 },
    { categorySlug: 'forestry', buckets: ['life_health'], weight: 5 },
    { categorySlug: 'aquaculture', buckets: ['life_health'], weight: 3 },
    { categorySlug: 'grassland-science', buckets: ['life_health'], weight: 3 },
  ],
  '10': [ // 医学
    { categorySlug: 'clinical-medicine', buckets: ['life_health'], weight: 20 },
    { categorySlug: 'pharmacy', buckets: ['life_health'], weight: 12 },
    { categorySlug: 'nursing', buckets: ['life_health'], weight: 12 },
    { categorySlug: 'stomatology', buckets: ['life_health'], weight: 14 },
    { categorySlug: 'public-health', buckets: ['life_health', 'social_science'], weight: 9 },
    { categorySlug: 'medical-technology', buckets: ['life_health', 'stem'], weight: 8 },
    { categorySlug: 'basic-medicine', buckets: ['life_health'], weight: 6 },
    { categorySlug: 'tcm', buckets: ['life_health'], weight: 11 },
    { categorySlug: 'integrated-medicine', buckets: ['life_health'], weight: 7 },
    { categorySlug: 'chinese-pharmacy', buckets: ['life_health'], weight: 7 },
  ...
  '12': [ // 管理学
    ...
    { categorySlug: 'tourism-management', buckets: ['business'], weight: 8 },
    { categorySlug: 'agri-economics', buckets: ['business', 'life_health'], weight: 3 },
    { categorySlug: 'library-science', buckets: ['social_science'], weight: 5 },
    { categorySlug: 'logistics', buckets: ['business', 'stem'], weight: 7 },
    { categorySlug: 'industrial-engineering', buckets: ['stem', 'business'], weight: 7 },
  ],
  '13': [ // 艺术学
    { categorySlug: 'design', buckets: ['art_creative', 'stem'], weight: 11 },
    { categorySlug: 'fine-arts', buckets: ['art_creative'], weight: 9 },
    { categorySlug: 'drama-film', buckets: ['art_creative'], weight: 8 },
    { categorySlug: 'music-dance', buckets: ['art_creative'], weight: 9 },
    { categorySlug: 'art-theory', buckets: ['art_creative', 'humanities'], weight: 4 },
  ],
  '14': [ // 交叉学科
    { categorySlug: 'interdisciplinary-class', buckets: ['stem', 'life_health'], weight: 6 },
  ],
};
