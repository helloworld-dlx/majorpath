...
> = {
  ...
  '07': [ // 理学
    ...
    { categorySlug: 'physics', buckets: ['stem'], weight: 12 },
  ...
  '08': [ // 工学 — 全部 32 个专业类
    ...
    { categorySlug: 'automation', buckets: ['stem'], weight: 10 },
    { categorySlug: 'mechanical', buckets: ['stem'], weight: 12 },
    { categorySlug: 'aerospace', buckets: ['stem'], weight: 14 },
