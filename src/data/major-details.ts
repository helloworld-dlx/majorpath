...
export const majorDetails: MajorDetailMap = {
  ...
  'engineering/ic-design': {
    ...
    oneLiner:
      '集成电路设计与集成系统，简单说就是：学习怎么把一个复杂电子系统，浓缩到一小块芯片里。你可以把它想象成：手机、电脑、耳机、汽车、智能手表里都有很多"会思考、会计算、会控制"的小零件，而这个专业研究的就是这些小零件背后的核心——芯片。它不是简单修电脑，也不是单纯焊电路板，更不是每天在工厂里造芯片。它更像是在学习：电流怎么流、信号怎么变、逻辑怎么判断、芯片内部的"小城市"怎么规划，最后怎样让一块很小的东西完成计算、存储、控制、通信等功能。',
    ...
    relatedMajorDiff: [
      'vs 电子科学与技术：电子科学与技术范围更大，像一个"大伞"——可能包括微电子、光电子、电磁场、电子材料、器件、集成电路等很多方向。集成电路设计与集成系统更像是这把伞下面更具体的一个方向，重点更集中在芯片设计、集成电路系统和相关工程应用上。简单说：电子科学与技术更宽，可能更偏基础和多方向；集成电路设计与集成系统更专，名字就直接指向芯片设计和系统集成。',
      'vs 微电子科学与工程：这两个专业非常接近，很多学校也会放在同一个学院里。微电子科学与工程通常更强调"芯片为什么能工作"，会更多接触半导体物理、器件、工艺、材料等内容。集成电路设计与集成系统通常更强调"怎么把电路设计成芯片系统"，会更关注电路设计、模块设计、系统实现、仿真验证和工具使用。简单说：微电子科学与工程更像是在问：晶体管、器件、工艺这些底层东西怎么回事？集成电路设计与集成系统更像是在问：怎么把这些东西组织起来，设计成一块能工作的芯片？但注意，不同学校差别很大，有些学校的微电子也很偏设计，有些学校的集成电路也可能很偏材料或工艺，一定要看课程表。',
      'vs 电子信息工程：电子信息工程范围也很宽，通常会学电路、信号、通信、嵌入式、信息处理等内容。它更像是"电子信息系统"的综合专业。集成电路设计与集成系统更底层、更专门，聚焦芯片和集成电路。如果说电子信息工程是在学"电子设备和信息系统怎么工作"，那集成电路设计与集成系统更像是在学"这些电子系统里面最核心的芯片怎么设计"。',
      'vs 计算机科学与技术：计算机更偏软件、算法、操作系统、数据库、网络、人工智能等。你主要是在写程序，让已有硬件去完成任务。集成电路更偏硬件底层。你关心的是：这个硬件本身怎么被设计出来？计算和控制功能怎样变成真实电路？简单说：计算机更像是在"用芯片做事情"；集成电路更像是在"设计芯片本身"。',
      'vs 自动化：自动化关注的是控制系统，比如让机器、设备、生产线按照设定方式运行。它会学控制理论、电路、传感器、程序、系统工程等。集成电路则更关注这些系统背后的芯片和电路基础。自动化更像是在研究"怎么控制一个系统"；集成电路更像是在研究"控制和计算背后的芯片怎么做"。',
      'vs 材料类专业：材料类专业更关注材料本身，比如材料结构、性能、制备和应用。半导体材料确实和芯片有关，但材料类不等于芯片设计。有些学校的集成电路专业实际可能偏材料或器件，这不一定不好，但和"芯片设计"不是一回事。如果你想学的是芯片设计，就要特别注意培养方案里到底有没有足够多的电路设计、芯片设计、EDA 工具和系统课程。',
    ],
